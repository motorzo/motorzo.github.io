...
if ( $mapWrapper.length > 0 ) {
	var map = new GMaps({
		div: '#map',
		lat : 12.938789, // Provide your longtitude
		lng : 77.631291,  // Provide your longtitude
		scrollwheel: false,
	...
	map.addMarker({
		...
		icon: 'img/marker.png',
		infoWindow: {
			content: '<p>MotorZo [Autoginie Services pvt ltd]</p>' // Provide your address to show on pop up
		}
	});
}
